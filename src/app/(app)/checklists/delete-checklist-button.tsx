    ...
    >
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            This deletes the checklist, its items, and any trade checkmarks
            against those items. This cannot be undone.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
          ...
          <AlertDialogAction
            disabled={pending}
            onClick={() => startTransition(() => deleteChecklistAction(id))}
          >
            Delete
          </AlertDialogAction>
        </AlertDialogFooter>
