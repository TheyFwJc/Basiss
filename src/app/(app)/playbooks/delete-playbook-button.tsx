...
import { deletePlaybookAction } from "./actions";

export function DeletePlaybookButton({ id, name }: { id: string; name: string }) {
    ...
    >
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Trades already tagged with this playbook will keep their history,
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction
            disabled={pending}
            onClick={() => startTransition(() => deletePlaybookAction(id))}
          >
            Delete
          </AlertDialogAction>
        </AlertDialogFooter>
